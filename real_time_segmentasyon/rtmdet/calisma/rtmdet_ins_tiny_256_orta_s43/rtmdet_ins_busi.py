...
custom_hooks = [
    ...
    dict(
        dataloader=dict(
            ...
            dataset=dict(
                ann_file=
                'd:/mamografi/real_time_segmentasyon/veri/coco/busi_val.json',
                data_prefix=dict(img=''),
                data_root=
                'd:/mamografi/real_time_segmentasyon/Dataset_BUSI_with_GT/',
...
randomness = dict(deterministic=False, seed=43)
resume = False
...
val_evaluator = [
    dict(
        ...
        type='CocoMetricHizali'),
    dict(
        manifest='d:/mamografi/real_time_segmentasyon/veri/veri_manifest.csv',
        type='BusiDiceMetric'),
]
...
work_dir = 'd:/mamografi/real_time_segmentasyon/rtmdet/calisma/rtmdet_ins_tiny_256_orta_s43'
